...
use Bot\Telegram\TelegramResponse;
/**
 *
 * @author rusakov.vv
 *
 ...
 */
class TelegramResponseException extends BotCommonException
{
    /**
     ...
     * @param BotCommonException $previousException The more detailed exception.
     */
    public function __construct(TelegramResponse $response, BotCommonException $previousException = null)
    {
    ...
    public static function create(TelegramResponse $response)
    {
        ...
        // Others
        return new static($response, new BotOtherException($message, $code));
    }
    /**
