...
class TelegramRequest
{
     ...
     */
    public function __construct($accessToken = null, $method = null, $endpoint = null, array $params = [], $isAsyncRequest = false, $timeOut = 60, $connectTimeOut = 10)
    {
    ...
    public function validateAccessToken()
    {
        ...
        if ($accessToken === null) {
            throw new BotCommonException('You must provide your bot access token to make any API requests.');
        }
    }
    ...
    {
        if (! $this->method) {
            throw new BotCommonException('HTTP method not specified.');
        }
        if (! in_array($this->method, [
            'GET',
            'POST'
        ])) {
            throw new BotCommonException('Invalid HTTP method specified.');
        }
    }
    ...
    {
        return [
            'User-Agent' => 'Telegram Bot PHP ' . Api::VERSION . ' - (https://github.com/WhiteKn1ght/telegram-bot-zf-expressive)'
        ];
    }
